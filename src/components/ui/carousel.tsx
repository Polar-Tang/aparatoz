...
function Carousel({
  ...
  className,
  children,
  autoAdvanceInterval = 3000, // New prop for customizable interval
  ...props
}: React.ComponentProps<"div"> & CarouselProps & { autoAdvanceInterval?: number }) {
  ...
  const selectedScroll = api?.selectedScrollSnap()
  ...
  return (
    ...
    >
      ...
      >
        <Progress 
          value={progress} 
          className="w-full absolute top-0 z-2 h-1" 
        />
        {children}
      </div>
    </CarouselContext.Provider>
